...
PICARD_VERSIONS = {
    ...
    'beta': {
        ...
        'urls': {
            ...
            'changelog': 'https://picard.musicbrainz.org/changelog/#release-2.7.0b1',
        },
        'win_size': '34',
        'win_hash': '49518f8308ddee56e6ad032732cf7949',
        'win_portable_size': '49',
        'win_portable_hash': '35761c94dc0686067e9f8945d41c48a3',
        'mac_10_12_size': '37',
        'mac_10_12_hash': 'f5ab96ea942df215f9f506eacd2718f0',
        'mac_size': '39',
        'mac_hash': 'b73e011bc963ab08c74bc68e4db144a8',
        'linux_size': '5',
        'linux_hash': '1cbec767668f8eeaa9acb885b9a4512a',
    },
    'dev': {
        'tag': '2.7.0b1',
        'version': (2, 7, 0, 'beta', 1),
        'urls': {
            'download':
            'https://github.com/metabrainz/picard/releases/tag/release-2.7.0b1',
        }
    },
}
