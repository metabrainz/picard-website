...
PICARD_VERSIONS = {
    'stable': {
        'tag': '2.12.2',
        'version': (2, 12, 2, 'final', 0),
        'urls': {
            'download': 'https://picard.musicbrainz.org/',
            'changelog': 'https://blog.metabrainz.org/2024/08/27/picard-2-12-2-released/',
        },
        'win_size': '31',
        'win_hash': '54a3a3eaff982ffebc5da1f27297cade',
        'win_portable_size': '45',
        'win_portable_hash': '0b458190ae98e5cd49a9ac6c5b81899b',
        'mac_10_12_size': '36',
        'mac_10_12_hash': '25b825ac4b2ec1f502ea43899b32d268',
        'mac_size': '38',
        'mac_hash': 'bbd7a42c2af9311931ef17c993d77337',
        'source_tar_size': '5.6',
        'source_tar_hash': '193ac29ae62005509d00553795e18767',
        'source_zip_size': '6.2',
        'source_zip_hash': '7e03610a5301883ecd31f6cfba148abd',
    },
    'beta': {
        'tag': '2.11.0rc1',
        'version': (2, 11, 0, 'rc', 1),
