...
PICARD_VERSIONS = {
    'stable': {
        ...
        'win_size': '29',
        'win_hash': '00000000000000000000000000000000',
        'win_portable_size': '42',
        'win_portable_hash': '00000000000000000000000000000000',
        'mac_size': '31',
        'mac_hash': '00000000000000000000000000000000',
        'linux_size': '3.7',
        'linux_hash': '-',
    },
    'beta': {
        ...
        'urls': {
            'download': 'https://github.com/metabrainz/picard/releases/tag/release-2.3.0b1',
            'changelog': 'https://blog.metabrainz.org/2020/01/30/picard-2-3-beta-1/',
        }
    },
    'dev': {
        'tag': '2.3.0b1',
